              ...
              {playlists.map((playlist) => (
                <>
                  <span className=" flex-hz">
                    <input
                      className="playlist-selection-item-checkbox"
                      type="checkbox"
                      onChange={(e) =>
                        addVideoToPlayList(
                          playlist._id,
                    ...
                    />
                    <label className="playlist-selection-item-label">
                      {playlist.title}
                    </label>
                  </span>
                </>
          ...
          {playlistName === "" ? (
            <>
              ...
              <button
                ...
                onClick={(e) => setShowInputBox(!showInputBox)}
              >
                Create new PlayList
              </button>
            </>
