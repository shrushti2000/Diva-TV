            ...
            <div className='video-item-container flex-vt'>
                ...
                <div className='video-item-footer flex-hz'>
                    ...
                    <div className='video-item-footer-2'>
                        ...
                        {showCTAcontainer && <>
                            <div className='video-item-cta-container flex-vt' onClick={() => removeVideofromPlaylist(playlistId, videoItem._id, token, dispatch, setShowCTAcontainer, showCTAcontainer)}>
                                <div className='video-item-cta-item flex-hz'><FontAwesomeIcon className='video-item-cta-icon' icon={faTrash} ></FontAwesomeIcon><p className='playlist-video-item-cta-text'>Remove from Playlist</p></div>
                            </div>
                        </>}
                    </div>
                </div>
